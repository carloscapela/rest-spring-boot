...
import br.com.restfullspringboot.mocks.MockBook;
...
class BookServicesTest {
	...
	void testFindById() {
		...
		assertEquals(25F, Optional.ofNullable(result.getPrice()));
...
//	}
	...
	void testFindAll() {
		...
		assertEquals(Optional.of(25F), Optional.ofNullable(bookOne.getPrice()));
		...
		assertEquals(25F, Optional.ofNullable(bookFour.getPrice()));
		...
		assertEquals(25F, Optional.ofNullable(bookSeven.getPrice()));
